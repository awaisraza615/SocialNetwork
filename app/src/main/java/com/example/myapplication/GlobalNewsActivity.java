...
public class GlobalNewsActivity extends AppCompatActivity {
    ...
    Dialog dialog;
    final String API_KEY = "2522c889e1fe42c4a4f470b6d314b4a4";
    Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(GlobalNewsActivity.this);
        ...
        call.enqueue(new Callback<Headlines>() {
            ...
            public void onResponse(Call<Headlines> call, Response<Headlines> response) {
                if (response.isSuccessful() && response.body().getArticles() != null){
                    ...
                    adapter = new Adapter(GlobalNewsActivity.this,articles);
            ...
            public void onFailure(Call<Headlines> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(GlobalNewsActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
